...
class AutoEnhanceTestCase(unittest.TestCase):
    ...
    def test_get_img_status(self):
        ...
        success_response = {
            'image_id': '52ceddc6-1940-485a-98bf-2d122e71806c',
        ...
        result = self.auto_enhance.get_img_status(image_id='52ceddc6-1940-485a-98bf-2d122e71806c')
    ...
    def test_preview_enhanced_img(self):
        ...
        result = self.auto_enhance.preview_enhanced_img(image_id='52ceddc6-1940-485a-98bf-2d122e71806c')
    ...
    def test_web_optimised_img(self):
        ...
        result = self.auto_enhance.web_optimised_img(image_id='52ceddc6-1940-485a-98bf-2d122e71806c')
        self.assertEqual(result.get('status'), success_response)
    ...
    def test_full_resol_enhanced_img(self):
        ...
        result = self.auto_enhance.full_resol_enhanced_img(image_id='52ceddc6-1940-485a-98bf-2d122e71806c')
        self.assertEqual(result.get('status'), success_response)
